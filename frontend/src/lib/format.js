...
export const time = (iso) => new Intl.DateTimeFormat('en-GB', {
  timeZone: 'Asia/Singapore', hour: '2-digit', minute: '2-digit'
}).format(new Date(iso));
export const dateLabel = (iso) => new Intl.DateTimeFormat('en-GB', {
...
export function endOf(start, minutes) { return new Date(new Date(start).getTime() + minutes * 60000).toISOString(); }
